                ...
                <div class="col-lg-3 col-md-3">
                    <div class="header__nav__option">
                        <a href="#" class="search-switch"><img
                                src="{{ 'public/frontend/img/icon/search.png' }}" alt=""></a>
                        <a href="#"><img src="{{ 'public/frontend/img/icon/heart.png' }}"
                                alt=""></a>
                        <a href="#"><img src="{{ 'public/frontend/img/icon/cart.png' }}" alt="">
                            <span>0</span></a>
                        <div class="price">$0.00</div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        <div class="footer__logo">
                            <a href="#"><img src="{{ 'public/frontend/img/footer-logo.png' }}"
                                    alt=""></a>
                        </div>
